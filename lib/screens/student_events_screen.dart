...
class _StudentEventsScreenState extends State<StudentEventsScreen>
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: 2, vsync: this); // Only Upcoming and Past for students
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // No FAB for students - they can only register, not create events
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Next Event Banner
          StreamBuilder<Event?>(
            stream: _firestoreService.streamNextEvent(),
  ...
  Widget _buildUpcomingEvents(bool isDark) {
    return StreamBuilder<List<Event>>(
      stream: _firestoreService.streamUpcomingEvents(),
      builder: (context, snapshot) {
  ...
  Widget _buildEventCard(Event event, bool isDark, {bool isPast = false}) {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text('Hosted by ${event.createdByName}'),
                      ],
                    ),
                    const SizedBox(height: 24),
