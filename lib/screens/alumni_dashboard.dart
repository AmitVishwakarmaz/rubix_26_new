...
class _AlumniDashboardState extends State<AlumniDashboard> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(feature['title'] as String, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          );
  ...
  // --- Reusable UI Helper Methods (Matching Student Dashboard Style) ---
      ...
      child: Row(
        ...
        children: [
          ...
          if (action.isNotEmpty)
            TextButton(onPressed: onTap, child: Text(action, style: const TextStyle(color: Color(0xFF6C63FF), fontWeight: FontWeight.w600))),
        ],
      ),
    );
  }
  ...
  Widget _buildFloatingActionButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(colors: [Color(0xFFFF6B9D), Color(0xFFFFA726)]),
        shape: BoxShape.circle,
        boxShadow: [BoxShadow(color: const Color(0xFFFF6B9D).withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 10))],
      ),
      child: IconButton(
